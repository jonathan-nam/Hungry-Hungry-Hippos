...
public class TitleScreen extends JPanel implements Runnable, MouseListener, KeyListener
{
	...
	public TitleScreen()
	{
		...
		try 
		{
			titleImage = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\HHHTitle.png"));
			landImage = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\CoverHippoGround.png"));
			hippoImage = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\Hippo8.png"));
		} 
		catch(Exception e) {
			e.printStackTrace();
		}
