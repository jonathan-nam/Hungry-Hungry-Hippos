...
public class HungryHungryHippos implements KeyListener
{
	...
	public class playingArea extends JPanel implements Runnable, MouseListener, KeyListener
	{
		...
		public playingArea() 
		{
		    ...
		    try 
		    {
		    	BlueHippo = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\BH_Cut.png"));
		    	BlueHippoExt = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\BHE_Cut.png"));
		    	PinkHippo = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\PH_Cut.png"));
		    	PinkHippoExt = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\PHE_Cut.png"));
		    	GreenHippo = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\GH_Cut.png"));
		    	GreenHippoExt = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\GHE_Cut.png"));
		    	OrangeHippo = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\OH_Cut.png"));
		    	OrangeHippoExt = ImageIO.read(new File("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\OHE_Cut.png"));
		    	background = ImageIO.read(new File ("C:\\EclipseWkOxygen64\\HungryHungryHippos\\src\\background.png"));
		    } 
		    catch(Exception e) {
		    	e.printStackTrace();
		    }
